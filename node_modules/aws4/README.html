...
a(href="/")
	img(src="/img/flag-usa.svg")
--></ul></div></div></header><h2>aws4</h2><p><a href="http://travis-ci.org/mhart/aws4"><img src="https://secure.travis-ci.org/mhart/aws4.png?branch=master" alt="Build Status"></a></p>
...
var password = signer.getDateTime() + &#39;Z&#39; + signer.signature()</code></pre>
...
export AWS_SESSION_TOKEN=&quot;&lt;your-session-token&gt;&quot;</code></pre><p>(will also use <code>AWS_ACCESS_KEY</code> and <code>AWS_SECRET_KEY</code> if available)</p>
...
<pre><code>npm install aws4</code></pre><p>Can also be used <a href="./browser">in the browser</a>.</p>
