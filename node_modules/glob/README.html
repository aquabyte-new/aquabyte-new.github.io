...
a(href="/")
	img(src="/img/flag-usa.svg")
--></ul></div></div></header><h1>Glob</h1><p>Match files using the patterns the shell uses, like stars and stuff.</p>
...
<pre><code>npm i glob</code></pre><pre><code class="language-javascript">var glob = require(&quot;glob&quot;)
...
a*s*d*f</code></pre><p>To get the bash-style behavior, set the <code>nonull:true</code> in the options.</p>
<h3>See Also:</h3><ul>
